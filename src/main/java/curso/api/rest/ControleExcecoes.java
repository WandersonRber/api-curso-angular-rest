...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	/* Interceptar error mais comuns no projeto */
	...
	/* Tratamento de da maioria dos erros a nível de banco de dados */
	...
	protected ResponseEntity<Object> handleExcpetionDataIntegry(Exception ex) {
		...
		objectError
				.setCode(HttpStatus.INTERNAL_SERVER_ERROR + "==>" + HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase());
